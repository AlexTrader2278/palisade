...
export async function summarize(
  ...
  const system = [
    ...
    "НЕ ПУТАЙ категории жидкостей и расходников: моторное масло, трансмиссионное масло, антифриз и AdBlue (мочевина) — это РАЗНЫЕ вещи. Если спросили про масло — пиши только про моторное масло, не приплетай AdBlue/антифриз. Отвечай строго на заданный вопрос, не уводи в сторону.",
    "НЕ называй людей по именам/никам и не цитируй имена участников — пиши обезличенно («владельцы советуют», «один из участников»). Бренды, марки и модели запчастей называть нужно.",
